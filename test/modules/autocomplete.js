export default class Autocomplete {
    ...
    onChange() {
        this.results.addEventListener('click', (event) => {
            ...
            let countryValue = current.getAttribute("data-value");
            if (countryValue) {
                this.handleResultSelected(countryValue);
            }
            return countryValue;
        });
    }
        ...
        this.input.addEventListener("keyup", (event) => {
            ...
            if (event.which === 40) {
                if (this.liSelected) {
                    ...
                    let next = this.liSelected.nextElementSibling;
                    if (next) {
            ...
            if (event.which === 13) {
                if (this.liSelected) {
                    let countryValue = this.liSelected.getAttribute("data-value");
                    if (countryValue) {
                        this.handleResultSelected(countryValue);
                    }
                }
