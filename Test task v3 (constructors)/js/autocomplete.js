    ...
    const autocomplete = function() {
        // In case if the constructor was called without "new".  
        if (!(this instanceof autocomplete)) {
          throw new Error("autocomplete is a constructor function, use new with it");
        }
        this.data = {},
        this.input = null,
        this.results = null,
        ...
        this.generateArray = () => {
            ...
            if (value) {
                ...
                newData = JSON.parse(dataCountries);
                backupData = [];
                let temporaryArray = [];
                Object.keys(newData)
    ...
    var autocomplete = {
        ...
        init(data, inputId) {
            this.data = data;
            this.input = document.getElementById(inputId);
            this.input.insertAdjacentHTML('afterend', '<div id="results" class="results" ></div>');
            this.results = document.getElementById("results");

            this.input.addEventListener("focus", () => {
                if (results.classList) {
                    results.classList.add("results--visability");
                    this.generateArray();
                }
