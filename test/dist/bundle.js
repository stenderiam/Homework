...
var _countries = require('./data/countries.js');

var _chips = require('./modules/chips.js');
...
},{"./data/countries.js":1,"./modules/chips.js":4}],3:[function(require,module,exports){
'use strict';
...
var Autocomplete = function () {
    ...
    _createClass(Autocomplete, [{
        ...
        // alert calls by clicking on the current field (results__line)
        ...
        value: function onChange() {
            ...
            this.results.addEventListener('click', function (event) {
                ...
                var countryValue = current.getAttribute("data-value");
                if (countryValue) {
                    _this3.handleResultSelected(countryValue);
                }
                return countryValue;
            });
        }
        ...
        value: function keyNavigation() {
            ...
            this.input.addEventListener("keyup", function (event) {
                ...
                if (event.which === 13) {
                    if (_this4.liSelected) {
                        var countryValue = _this4.liSelected.getAttribute("data-value");
                        if (countryValue) {
                            _this4.handleResultSelected(countryValue);
                        }
                    }
                }
            });
        ...
        key: 'alertEvent',
        value: function alertEvent(countryValue) {
            this.input.value = countryValue;
            alert(countryValue);
        }
    }, {
        key: 'handleResultSelected',
        value: function handleResultSelected(countryValue) {
            this.alertEvent(countryValue);
        }
    }]);
...
var Chips = function (_Autocomplete) {
    ...
    _createClass(Chips, [{
        ...
        key: 'addChip',
        value: function addChip(countryValue) {
        ...
        key: 'createChip',
        value: function createChip(countryValue) {
            this.chipsArray.push(countryValue);
            var chipDivStart = '<div class="chips"><div class="chip container__chip">';
            var chipDivEnd = '<div class="chip__icon"><img src="./icons/delete.png" alt="delete icon"></div></div></div>';
            this.results.insertAdjacentHTML('afterbegin', chipDivStart + countryValue + chipDivEnd);

            // just to check if the filter 
        ...
        key: 'filterChipArray',
        value: function filterChipArray() {
            var obj = {};
            for (var i = 0; i < this.chipsArray.length; i++) {
                var str = this.chipsArray[i];
                obj[str] = true;
            }
